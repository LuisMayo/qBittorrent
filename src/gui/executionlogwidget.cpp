    ...
    , m_peerView(new LogListView(this))
{
    ...
    connect(m_messageView, &LogListView::customContextMenuRequested, [this](const QPoint &pos) {
    ...
    connect(m_peerView, &LogListView::customContextMenuRequested, [this](const QPoint &pos) {
